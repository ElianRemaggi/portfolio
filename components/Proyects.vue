...
<template>
    ...
    <div v-if="shouldRender"
        ...
        <DnaBackground class=" z-10" />

        <section class="fixed top-0 right-0  z-11">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div class="max-w-screen-md mb-8 lg:mb-16">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Proyects </h2>
